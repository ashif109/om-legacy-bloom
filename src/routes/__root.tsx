...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Triyambkeshwar Nath Tyagi — Environmentalist & Climate Action Advocate" },
      { name: "twitter:description", content: "Portfolio of Triyambkeshwar Nath Tyagi — working for Environment and Climate Action." },
