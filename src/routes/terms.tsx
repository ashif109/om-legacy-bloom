  ...
  component: () => (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-32 space-y-4 text-[color:var(--muted-foreground)]">
        <p>By using this site you agree to use content for personal, educational and non-commercial purposes. Images and text are the property of Om and Sanatan Gurukulam unless otherwise stated.</p>
